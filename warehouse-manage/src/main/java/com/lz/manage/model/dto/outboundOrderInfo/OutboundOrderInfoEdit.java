 ...
 */
@Data
public class OutboundOrderInfoEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param outboundOrderInfoEdit 编辑对象
     * @return OutboundOrderInfo
     */
    public static OutboundOrderInfo editToObj(OutboundOrderInfoEdit outboundOrderInfoEdit) {
        if (outboundOrderInfoEdit == null) {
            return null;
        }
        OutboundOrderInfo outboundOrderInfo = new OutboundOrderInfo();
        BeanUtils.copyProperties(outboundOrderInfoEdit, outboundOrderInfo);
        return outboundOrderInfo;
    }
}
