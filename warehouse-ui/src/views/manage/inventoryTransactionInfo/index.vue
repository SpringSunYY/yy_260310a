    ...
    <el-table v-loading="loading" :data="inventoryTransactionInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="编号" align="center" prop="id" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="批次号" align="center" prop="batchNo" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="变动数量" align="center" prop="changeQuantity" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="变动前库存量" align="center" prop="beforeQuantity" v-if="columns[7].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="变动后库存量" align="center" prop="afterQuantity" v-if="columns[8].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="关联单号" align="center" prop="relatedOrderNo" v-if="columns[9].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="操作人" align="center" prop="operatorId" v-if="columns[10].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="流水时间" align="center" prop="transactionTime" width="180" v-if="columns[11].visible" :show-overflow-tooltip="true">
                <template #default="scope">
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:inventoryTransactionInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:inventoryTransactionInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="InventoryTransactionInfo">
  import { listInventoryTransactionInfo, getInventoryTransactionInfo, delInventoryTransactionInfo, addInventoryTransactionInfo, updateInventoryTransactionInfo } from "@/api/manage/inventoryTransactionInfo";
