...
public interface PurchaseOrderInfoMapper extends BaseMapper<PurchaseOrderInfo> {
    ...
    default PurchaseOrderInfo selectPurchaseOrderInfoByNo(String orderNo) {
        return selectOne(new LambdaQueryWrapper<PurchaseOrderInfo>().eq(PurchaseOrderInfo::getOrderNo, orderNo));
    }
}
