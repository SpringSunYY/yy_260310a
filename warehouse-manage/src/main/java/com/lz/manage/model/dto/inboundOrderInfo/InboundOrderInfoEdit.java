 ...
 */
@Data
public class InboundOrderInfoEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param inboundOrderInfoEdit 编辑对象
     * @return InboundOrderInfo
     */
    public static InboundOrderInfo editToObj(InboundOrderInfoEdit inboundOrderInfoEdit) {
        if (inboundOrderInfoEdit == null) {
            return null;
        }
        InboundOrderInfo inboundOrderInfo = new InboundOrderInfo();
        BeanUtils.copyProperties(inboundOrderInfoEdit, inboundOrderInfo);
        return inboundOrderInfo;
    }
}
